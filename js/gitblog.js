    ...
    Issue.prototype = {
        ...
        addItem: function(data) {
            ...
            for (var i in data) {
                ...
                document.getElementById('issue-list').innerHTML += '<article class="post card bg-white shadow-sm border-0 post-preview post-preview-layout-2" id="' + data[i].number + '"><header class="post-header "></header><div class="post-content-container"><a class="post-title" href="content.html?id=' + data[i].number + '">' + data[i].title + '</a><div class="post-content">' + data[i].body + '</div><div class="post-meta"><div class="post-meta-detail post-meta-detail-time"><i class="fa fa-clock-o" aria-hidden="true"></i><time title="' + data[i].created_at + '">' + data[i].created_at + '</time></div><div class="post-meta-devide">|</div><div class="post-meta-detail post-meta-detail-author"><i class="fa fa-user-circle-o" aria-hidden="true"></i><a href="https://github.com/' + data[i].user.login + '" target="_blank">' + data[i].user.login + '</a></div><div class="post-meta-devide">|</div><div class="post-meta-detail post-meta-detail-categories"><i class="fa fa-bookmark-o" aria-hidden="true"></i><a href="" target="_blank" class="post-meta-detail-catagory-link">' + labels_content + '</a></div></div></div></article>';
            }
        },
