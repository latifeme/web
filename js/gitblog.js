    ...
    Issue.prototype = {
        getTags: function() {
            $.ajax({
                ...
                success: function(data) {
                    for (var i in data) {
                        document.getElementById('tags').innerHTML += '<a href="/?label=' + data[i].name + '" class="nav-link"><i class="ni ni-book-bookmark d-lg-none"></i><span class="nav-link-inner--text">' + data[i].name + '</span></a></li>';
                    }
                },
            });
        },
