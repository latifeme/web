        ...
        init: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    document.getElementById('issue-list').innerHTML = '<article class="post post-full card bg-white shadow-sm border-0" id="' + self.options.id + '"><header class="post-header text-center"><a class="post-title" href="/?id=' + self.options.id + '">' + data.title + '</a><div class="post-meta"><div class="post-meta-detail post-meta-detail-time"><i class="fa fa-clock-o" aria-hidden="true"></i><time title="' + data.created_at + '">' + data.created_at + '</time></div><div class="post-meta-devide">|</div><div class="post-meta-detail post-meta-detail-author"><i class="fa fa-user-circle-o" aria-hidden="true"></i><a href="https://github.com/' + data.user.login + '" target="_blank">' + data.user.login + '</a></div><div class="post-meta-devide">|</div><div class="post-meta-detail post-meta-detail-categories"><i class="fa fa-bookmark-o" aria-hidden="true"></i><a href="/?label=' + data.labels.name + '" target="_blank" class="post-meta-detail-catagory-link">' + data.labels.name + '</a></div></div></header><div class="post-content" id="post_content">' + data.body_html + '<div class="uwp_widgets uwp_widget_author_box bsui sdel-fa446a3f"><div class="d-block text-center text-md-left d-md-flex p-3 bg-light"><a href="https://github.com/' + data.user.login + '" target="_blank"><img src="' + data.user.avatar_url + '&size=100" class="rounded-circle shadow border border-white border-width-4 mr-3" width="60" height="60" alt="' + data.user.login + '">' + data.user.login + '</a><div class="media-body"><h5 class="mt-0">Author: <a href="https://github.com/' + data.user.login + '">' + data.user.login + '</a></h5></div></div></div></div></article>';
